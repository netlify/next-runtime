...
describe('app dir next-image', () => {
  ...
  describe('ssr content', () => {
    it('should render images on / route', async () => {
      ...
      expect(layout.attr('src')).toBe('/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Ftest.3f1a293b.png&w=828&q=85')
      ...
      const page = $('#app-page')
      expect(page.attr('src')).toBe('/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Ftest.3f1a293b.png&w=828&q=90')
      ...
      const comp = $('#app-comp')
      expect(comp.attr('src')).toBe('/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Ftest.3f1a293b.png&w=828&q=80')
    ...
    it('should render images on /client route', async () => {
      ...
      expect(root.attr('src')).toBe('/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Ftest.3f1a293b.png&w=828&q=85')
      expect(root.attr('srcset')).toBe(
        '/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Ftest.3f1a293b.png&w=640&q=85 1x, /_next/image?url=%2F_next%2Fstatic%2Fmedia%2Ftest.3f1a293b.png&w=828&q=85 2x',
      )

      const layout = $('#app-client-layout')
      expect(layout.attr('src')).toBe('/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Ftest.3f1a293b.png&w=828&q=55')
      expect(layout.attr('srcset')).toBe(
      ...
      expect(page.attr('src')).toBe('/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Ftest.3f1a293b.png&w=828&q=60')
      expect(page.attr('srcset')).toBe(
      ...
      expect(comp.attr('src')).toBe('/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Ftest.3f1a293b.png&w=828&q=50')
      expect(comp.attr('srcset')).toBe(
    ...
    it('should render images nested under page dir on /nested route', async () => {
      ...
      expect(layout.attr('src')).toBe('/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Ftest.fab2915d.jpg&w=828&q=70')
      expect(layout.attr('srcset')).toBe(
      ...
      expect(page.attr('src')).toBe('/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Ftest.fab2915d.jpg&w=828&q=75')
      expect(page.attr('srcset')).toBe(
      ...
      expect(comp.attr('src')).toBe('/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Ftest.fab2915d.jpg&w=828&q=65')
      expect(comp.attr('srcset')).toBe(
  ...
  describe('image content', () => {
    ...
    it('should render images on /client route', async () => {
      ...
      const res2 = await fetchViaHTTP(next.url, $('#app-client-layout').attr('src'))
      expect(res2.status).toBe(200)
      expect(res2.headers.get('content-type')).toBe('image/png')

      const res3 = await fetchViaHTTP(next.url, $('#app-client-page').attr('src'))
      expect(res3.status).toBe(200)
      expect(res3.headers.get('content-type')).toBe('image/png')

      const res4 = await fetchViaHTTP(next.url, $('#app-client-comp').attr('src'))
    ...
    it('should render images nested under page dir on /nested route', async () => {
      ...
      const res2 = await fetchViaHTTP(next.url, $('#app-nested-layout').attr('src'))
      expect(res2.status).toBe(200)
      expect(res2.headers.get('content-type')).toBe('image/jpeg')

      const res3 = await fetchViaHTTP(next.url, $('#app-nested-page').attr('src'))
      expect(res3.status).toBe(200)
      expect(res3.headers.get('content-type')).toBe('image/jpeg')

      const res4 = await fetchViaHTTP(next.url, $('#app-nested-comp').attr('src'))
      expect(res4.status).toBe(200)
