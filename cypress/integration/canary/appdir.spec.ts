describe('app dir', () => {
  ...
  //         expect(res.status).toBe(500)
  //         expect(await res.text()).toContain('`getServerSideProps` is not allowed in Client Components')
  //       })
  ...
  //         expect(res.status).toBe(500)
  //         expect(await res.text()).toContain('`getStaticProps` is not allowed in Client Components')
  //       })
  //     }
  //   })
